  ...
  return (
    <section className="hero relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex-column m-auto px-10 py-20 text-white z-10 items-start justify-start">
        <h1 className="md:text-7xl text-4xl font-bold leading-tight">Lahore 101</h1>
        <p className="md:text-4xl text-2xl mt-4">Your perfect tour guide for visiting Lahore</p>
